  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[var(--background)] p-8 text-[var(--foreground)]">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold">Outlook error</h1>
        <p className="mt-3 text-sm leading-6 text-slate-500">Failed to generate market outlook.{error.digest ? ` (ref: ${error.digest})` : ""}</p>
        <button

        ...
        <header className="sticky top-0 z-10 border-b border-[var(--card-border)] bg-[var(--background)]/80 px-5 py-4 backdrop-blur-xl md:px-8 md:py-5">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
            <div className="animate-pulse space-y-2">
              ...
              <div className="h-6 w-44 rounded bg-slate-200 dark:bg-white/10" />
            </div>
          ...
          <div className="grid gap-6 xl:grid-cols-[1.3fr_1fr]">
            <div className="animate-pulse rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-6 shadow-sm">
              <div className="mb-6 space-y-3">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="h-14 rounded-xl bg-slate-200 dark:bg-white/10" />
                ))}
              </div>
            </div>
            <div className="animate-pulse rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-6 shadow-sm">
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-20 rounded-xl bg-slate-200 dark:bg-white/10" />
                ))}
              </div>
            </div>
          </div>
